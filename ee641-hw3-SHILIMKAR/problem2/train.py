...
def main():
    ...
    log_save_path = output_dir / 'training_log.json'
    curve_save_path = output_dir / 'training_curves.png'
    ...
    model = create_model(
        ...
        max_len=300 # Set a reasonable max_len for precomputation/embedding size
    ).to(args.device)
