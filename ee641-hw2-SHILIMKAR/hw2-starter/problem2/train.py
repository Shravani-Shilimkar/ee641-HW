...
def main():
    ...
    # train_dataset = DrumPatternDataset(config['data_dir'], split='train_patterns')
    # val_dataset = DrumPatternDataset(config['data_dir'], split='val_patterns')
